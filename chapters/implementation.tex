...
In this project, the \textbf{sun ray}, $\mathbf{sr}$, is the normalized vector from a point in the world, towards the sun. The sun is treated as a directional light source due to its immense distance from Earth, implying that the sun rays are parallel at every point.
...
.2 Source/.
.3 Input/.
.4 Camera.cpp.\DTcomment{Encapsulates camera transform and parameters}.
...
.4 Debug.frag/.\DTcomment{Renders various debugging views}.
.4 Shading.frag/.\DTcomment{Illumination and shadows for terrain, trees and water}.
.4 Raymarching.frag/.\DTcomment{Ray marching for terrain and trees}.
.4 Clouds.frag/.\DTcomment{Clouds procedural generation and volumetric rendering}.
.4 Trees.frag/.\DTcomment{Trees procedural generation}.
.4 Planet.frag/.\DTcomment{Planet procedural generation}.
.4 ValueNoise.frag/.\DTcomment{Value noise}.
.4 IntersectionDistanceError.frag/.\DTcomment{Computes IDE incrementally}.
.4 HeightDifferenceError.frag/.\DTcomment{Computes HDE}.
.4 fBm.frag/.\DTcomment{Fractal-noise implementation of fBm}.
.4 Terrain.frag/.\DTcomment{Heightmap procedural generation}.
.4 SphericalAtmosphere.frag/.\DTcomment{Atmosphere Simulation for planets}.
.4 Atmosphere.frag/.\DTcomment{Atmosphere simulation}.
.4 Profiling.frag/.\DTcomment{Macros for profiling}.
...
.4 Water.frag/.\DTcomment{Water normal map and }.
.4 Sun.frag/.\DTcomment{Sun direction and sun disk}.
.4 SmoothStep.frag/.\DTcomment{Smoothstep functions}.
.4 Hash.frag/.\DTcomment{Hash functions}.
.4 Constants.frag/.\DTcomment{Contains useful constants}.
.4 Motion.frag/.\DTcomment{Contains uniforms for animations.}.
